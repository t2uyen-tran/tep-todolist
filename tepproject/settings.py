...
SECRET_KEY = 'django-insecure-dfiqc$s07&&*5b-hv)(eq!*@ypsuy(_efyvp4mwe4j9ujyy3g3'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'todo.context_processors.add_variable_to_context',  # TTUT: add customised context_processor
            ],
        },
    },
]
